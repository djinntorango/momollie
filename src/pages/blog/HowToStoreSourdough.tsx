...
export default function HowToStoreSourdough() {
  return (
    <article className="max-w-4xl mx-auto px-4 py-12">
      ...
      <header className="mb-8">
        ...
        <div className="relative h-96 w-full rounded-lg overflow-hidden">
          <img src="/bake.png" alt="Fresh sourdough bread ready for storage" className="absolute inset-0 w-full h-full object-cover" />
        </div>
      </header>
